...
const COLORS = [
  "bg-indigo-700", "bg-emerald-700", "bg-amber-700", "bg-violet-700",
  "bg-rose-700", "bg-sky-700", "bg-lime-700", "bg-fuchsia-700", "bg-slate-600",
];

export function AllocationBar({ slices }: { slices: AllocationSlice[] }) {
  if (slices.length === 0) {
    return <p className="text-sm text-slate-500">No allocation data available.</p>;
  }
