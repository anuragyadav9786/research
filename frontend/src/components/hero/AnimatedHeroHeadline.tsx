...
export function AnimatedHeroHeadline({ centered = false }: { centered?: boolean }) {
  ...
  return (
    ...
    >
      {/* The visible content below cycles its text every few seconds via a
       * typewriter effect, which would otherwise give screen-reader users
       * navigating by heading a random, often mid-word fragment as this
       * page's most prominent h1 — a static, complete sentence here (never
       * mutated) is what "Know how your fund..." actually announces as. */}
      <span className="sr-only">Know how your fund actually behaves when the market drops or grows.</span>
