  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center px-6">
      <div className="max-w-sm text-center space-y-4">
        <div
          className="mx-auto h-8 w-8 rounded-full border-2 border-slate-700 border-t-indigo-400 animate-spin"
          role="status"
          aria-label="Loading"
        />
        <p className="text-sm text-slate-300">Loading fund research…</p>
